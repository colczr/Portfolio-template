...
! function(a, e, t, i) {
    ...
    function s(e, i, n) {
        ...
        s.each(function() {
            ...
            if (l > 0 && (i.lazyLoad ? c.appendTo(s) : e.find(c).length || c.appendTo(e)), d) {
                M && s.is("[data-video-bkg]") && s.children("video").css({
                    display: "none"
                });
            ...
            l ? s.find("img").each(function(e, d) {
                ...
                if ((t.isRetinaDevice() && i.retinaSupport || t.isRetinaDevice() && a(this).is("[data-retina]")) && (!M && !i.retinaSupportMobile || M && i.retinaSupportMobile) && (d.match(/\.(svg)/i) || (d = a(this).data("src").replace(c, i.retinaSuffix + c))), s.data("overlay-bkg-color") && !s.find(".tms-overlay").length) var u = s.data("overlay-bkg-color").replace("#", ""),
                    h = s.data("overlay-bkg-opacity") ? s.data("overlay-bkg-opacity") : .5,
                    p = parseInt(u.substring(0, 2), 16),
                    f = parseInt(u.substring(2, 4), 16),
                    m = parseInt(u.substring(4, 6), 16),
                    g = "rgba( " + p + "," + f + "," + m + "," + h / 1 + " )",
    ...
    function o(a, e, t, i) {
        ...
        if (a.find(".no-transition").css({
                visibility: "visible"
            }), 0 === n.height() && !n.data("height") && a.hasClass("active")) {
            o.children("img").css({
                maxHeight: "none"
            });
        ...
        if (v(a, t), g(n, t), t.carousel && !t.lazyLoad && (s.children().css({
                opacity: 1
            }), s.css({
                opacity: 0
            ...
            if (a.find(".tm-loader").length && a.find(".tm-loader").remove(), (a.is(o) || t.carouselVisible > 1) && a.find(".tms-caption").show(), !a.hasClass("active")) return !1;
            A ? (o.css({
                transition: "none",
                opacity: 0
        ...
        } else e === s.children().length && (n.find(".tm-loader").length && n.find(".tm-loader").remove(), o.find(".tms-caption").show(), t.carouselVisible > 1 && n.find(".tms-caption").show(), A ? t.carousel ? s.css({
            transitionProperty: "opacity",
            transitionDuration: "700ms",
            opacity: 1
        }) : o.css({
    ...
    var r = function(o, r) {
            var c = a.extend({}, a.fn.avalancheSlider.tmsOpts, r),
                p = a(o),
                b = this;
            c.scaleUnder = p.data("scale-under") ? p.data("scale-under") : c.scaleUnder;
            var y = c.fulscreen ? a(t).width() : c.fullwidth ? c.scaleUnder : parseFloat(p.data("width") ? p.data("width") : p.css("width")),
                x = c.fulscreen ? a(t).height() : parseFloat(p.data("height") ? p.data("height") : p.css("height"));
            c.scaleMinHeight = p.data("scale-min-height") ? p.data("scale-min-height") : c.scaleMinHeight, c.animation = p.data("animation") ? p.data("animation") : c.animation, c.easing = p.data("easing") ? p.data("easing") : c.easing, c.speed = p.data("speed") ? p.data("speed") : c.speed, c.carousel = p.data("carousel") ? p.data("carousel") : c.carousel, c.carouselVisible = p.data("carousel-visible-slides") ? p.data("carousel-visible-slides") : c.carouselVisible, c.showProgressBar = p.is('[data-progress-bar="false"]') ? !1 : c.showProgressBar, c.autoAdvance = p.is("[data-auto-advance]") ? !0 : c.autoAdvance, c.interval = p.data("auto-advance-interval") ? p.data("auto-advance-interval") : c.interval, c.pauseOnHover = p.is("[pause-on-hover=false]") ? !1 : c.pauseOnHover, c.navArrows = p.is("[data-nav-arrows=false]") ? !1 : c.navArrows, c.navPagination = p.is("[data-nav-pagination=false]") ? !1 : c.navPagination, c.navShowOnHover = p.is("[data-nav-show-on-hover=false]") ? !1 : c.navShowOnHover, p.data("transitioning", !1).data("setup", !1).data("loaded", !1).data("refW", y).data("refH", x).data("carousel-height", x), n(p);
            var S = p.find(".tms-slides").children("li:first-child").addClass("active");
            c.lazyLoad || S.css({
                opacity: 0
            }), S.is("[data-nav-dark]") && (p.addClass("tms-nav-dark"), p.is("[data-featured-slider]") && a("header").addClass("nav-dark")), g(p, c);
            var C = p.find(".tms-slides"),
                T = [];
            if (C.children(".tms-slide").each(function(e) {
            ...
            if (c.navPagination && C.children().length > 1) {
                for (var $ = a("<div>").addClass("tms-pagination").appendTo(p), H = 1; H < C.children().length + 1; H++) p.find($).append('<a href="#" id="tms-pagination-' + H + '" data-index="' + H + '" class="tms-bullet-nav" />');
                var k = p.find("bullets" === c.paginationType ? ".tms-bullet-nav" : ".tms-thumb-nav");
                k.each(function() {
                    a(this).on("click", function() {
                        return S = p.find("li.active"), a(this).hasClass("active") ? !1 : (c.autoAdvance && p.data("loaded") && b.resetSlideshow(), parseFloat(a(this).data("index")) > parseFloat($.find(".active").data("index")) ? b.slideTo(a(this).data("index"), "next") : b.slideTo(a(this).data("index"), "prev"), !1)
                    })
                }), $.find(".tms-bullet-nav:first-child").addClass("active"), c.lazyLoad && $.css({
                    display: "block"
                })
            }
            if (c.navShowOnHover && p.addClass("show-on-hover"), c.navKeyboard && C.children().length > 1) {
                var P = [];
                a(e).on("keydown", function(a) {
                    return P[a.keyCode] = !0, P[37] && P[39] ? !1 : (P[37] ? (c.autoAdvance && p.data("loaded") && b.resetSlideshow(), c.lazyLoad ? b.prevSlide() : p.data("loaded") && b.prevSlide()) : P[39] && (c.autoAdvance && p.data("loaded") && b.resetSlideshow(), c.lazyLoad ? b.nextSlide() : p.data("loaded") && b.nextSlide()), i)
                }).on("keyup", function(a) {
                    P[a.keyCode] = !1
                })
            }
            p.swipeIt({
                ...
                c.carousel && c.carouselVisible > 1 ? C.children(".tms-slide").each(function() {
                    v(a(this), c)
                }) : v(e, c), g(p, c), p.addClass("resizing"), F(function() {
            ...
            var I, E, D, B, L, W, U, R = null,
                Q = null;
            b.initSlideshow = function() {
                return I || C.children().length < 2 ? !1 : (c.autoAdvance = !0, !M && c.pauseOnHover && (C.on("mouseleave ", b.resumeSlideshow), C.on("mouseenter ", b.pauseSlideshow)), c.showProgressBar && (U = a("<div>").addClass("tms-progress-bar").appendTo(p)), b.startSlideshow(), q(c.interval), E = (new Date).getTime(), L = c.interval, c.onSlideshowStart && c.onSlideshowStart(), i)
            }, b.startSlideshow = function(a) {
                a = a ? B : c.interval, I = setInterval(function() {
                    a !== c.interval && (clearInterval(I), a = c.interval, L = c.interval, b.startSlideshow()), E = (new Date).getTime(), i !== U && U.css({
                        transition: "none",
                        width: "0px"
                    }), q(c.interval), b.nextSlide()
                }, a)
            }, b.pauseSlideshow = function() {
                return W || !I ? !1 : (clearInterval(I), D = (new Date).getTime(), B = 50 > L - (D - E) ? 50 : L - (D - E), L = 0 === L ? c.interval : B, i !== U && U.stop().css({
                    width: U.width() + "px"
                }), W = !0, c.onSlideshowPause && c.onSlideshowPause(), i)
            }, b.resumeSlideshow = function() {
                return W ? (clearInterval(I), p.data("ssPaused", !1), E = (new Date).getTime(), q(B), b.startSlideshow(B), W = !1, i) : !1
            }, b.resetSlideshow = function() {
                return I ? (clearInterval(I), i !== U && U.css({
                    transition: "none",
                    width: "0px"
                }), q(c.interval), E = (new Date).getTime(), B = c.interval, L = c.interval, b.startSlideshow(c.interval), i) : !1
            }, b.endSlideshow = function() {
                return I ? (clearInterval(I), I = "", W = !1, !M && c.pauseOnHover && (C.off("mouseleave ", b.resumeSlideshow), C.off("mouseenter ", b.pauseSlideshow)), i !== U && U.remove(), c.onSlideshowEnd && c.onSlideshowEnd(), i) : !1
            };
            var q = function(a) {
                return i === U ? !1 : (A ? (clearTimeout(R), R = setTimeout(function() {
                    U.css({
            ...
            b.nextSlide = function() {
                ...
                var e;
                S = p.find("li.active");
                var t = T[a.inArray(S.attr("id"), T) + 1];
                if (e = a.inArray(t, T) + 1 === 0 ? 1 : a.inArray(t, T) + 1, c.carousel && c.carouselVisible > 1) {
                    var i = m(p, c);
                    1 !== i && (e = e === C.children().length - (i - 2) ? 1 : a.inArray(t, T) + 1)
                }
                this.slideTo(e, "next")
                ...
                S = p.find("li.active");
                var t = T[a.inArray(S.attr("id"), T) - 1];
                if (e = a.inArray(t, T) + 1 === 0 ? C.children().length : a.inArray(t, T) + 1, c.carousel && c.carouselVisible > 1) {
                    var i = m(p, c);
                    e = e === C.children().length ? C.children().length - (i - 1) : a.inArray(t, T) + 1
                }
                this.slideTo(e, "prev")
            }, b.slideTo = function(e, t) {
                if (p.data("first-load", !1), t || (S = p.find("li.active")), p.data("transitioning") || e === a.inArray(S.attr("id"), T) + 1) return !1;
                f(p, e);
                var i = p.width(),
                    n = "slide" === c.animation ? i : 0;
                n *= c.carousel ? e - 1 : 1;
                var s = p.find("#tms-slide-" + e);
                s.addClass("target").css({
                    zIndex: 2,
                    opacity: 0 === n ? 0 : 1
                }), S.css({
                    zIndex: 1
                }), p.removeClass("tms-nav-dark"), a("header").removeClass("nav-dark"), s.is("[data-nav-dark]") && (p.addClass("tms-nav-dark"), p.is("[data-featured-slider]") && a("header").addClass("nav-dark")), w(s, c), (s.children("img").data("loaded") || !s.children("img").length) && v(s, c), g(p, c, s), t || (t = "next"), t = c.carousel ? 1 : "next" === t ? 1 : -1;
                var o = m(p, c);
                A ? c.carousel ? u(C, 1, -(n / o) * t, 0, 0, 0, 0, 0, 1, c.speed, 0, V[c.easing], c) : (s.css({
                    transition: "none",
                    transform: "translate3d(" + n * t + "px, 0, 0)"
                }), clearTimeout(Q), Q = setTimeout(function() {
                    u(S, 1, -n * t, 0, 0, 0, 0, 0, 1, c.speed, 0, V[c.easing], c), u(s, 1, 0, 0, 0, 0, 0, 0, 1, c.speed, 0, V[c.easing], c)
                }, 50)) : c.carousel ? (p.data("transitioning", !0), C.animate({
                    opacity: 1,
                    left: -(n / o) * t + "px"
        ...
        d = function(e, i) {
            var n = a(t),
                s = n.scrollTop(),
                o = (n.height(), e.parent().height() + e.parent().offset().top - s),
                r = s * i.parallaxSpeed,
                l = i.parallaxScaleOut ? 2 - o / e.parent().height() : 1;
            l = 1 > l ? 1 : l;
            var d = i.parallaxFadeOut ? o / e.parent().height() : 1;
            !M && A && c(e.parent()) && e.css({
        ...
        u = function(e, t, i, n, s, o, r, l, d, c, u, p, f) {
            var m = e.closest(".tm-slider-container");
            (e.hasClass("active") || e.hasClass("target") || e.hasClass("tms-slides")) && (m.data("transitioning", !0), f.onSlideBefore && f.onSlideBefore());
            var g = {};
            g.transform = "translate3d(" + i + "px, " + n + "px, " + s + "px)rotate3d( 1, 0, 0, " + o + "deg)rotate3d( 0, 1, 0, " + r + "deg)rotate3d( 0, 0, 1, " + l + "deg)scale3d(" + d + ", " + d + ", " + d + ")", g.transitionProperty = P + ", opacity", g.transitionDuration = c + "ms", g.transitionDelay = u + "ms", g.transitionTimingFunction = p, g.visibility = "visible", g.opacity = t, e.css(g).on(I, function(e) {
                e.stopPropagation(), a(this).off(I), (a(this).hasClass("target") || a(this).hasClass("tms-slides")) && h(m, f), a(this).hasClass("tms-caption") && a(this).css({
                    transition: ""
                })
            })
        },
        ...
        p = function(e, t) {
            e.find(".tms-caption").not(".no-transition").show().each(function() {
                var e = a(this),
                    ...
                    s = a(this).data("e") ? V[e.data("e")] : V[t.easing],
                    o = null;
                A ? (clearTimeout(o), o = setTimeout(function() {
                    u(e, 1, 0, 0, 0, 0, 0, 0, 1, i, n, s)
                }, 500)) : (s = t.easingFallback, e.delay(n).css({
                    visibility: "visible"
                }).animate({
                    opacity: 1
                }, i, s))
        ...
        g = function(e, t) {
            ...
            }), 2 === c && r > s.children().length - 2 ? (i = s.children().length - 1, n = !0) : 3 === c && r > s.children().length - 3 ? (i = s.children().length - 2, n = !0) : r > s.children().length - c ? (i = s.children().length - c + 1, n = !0) : (i = r, n = !1), l.children().hide().slice(0, s.children().length - c + 1).show(), n && (o.removeClass("active"), s.find("li:nth-child(" + i + ")").addClass("active"), f(e, i)), A ? (e.data("transitioning") || s.css({
                width: u * d + "px",
                transition: "none",
        ...
        v = function(e, i) {
            var n = e.closest(".tm-slider-container, .featured-media"),
                s = n.parent().width(),
                o = i.fsUseHeightOf ? i.fsUseHeightOf.height() : a(t).height(),
                r = n.data("refW"),
                l = n.data("refH"),
                d = i.fullscreen ? a(t).width() / o : r / l,
                c = n.data("external-padding") ? parseFloat(n.data("external-padding")) : i.externalPadding,
                u = i.fullscreen || i.fullwidth ? a(t).width() - c : s,
                h = i.fullscreen ? o - c : i.carousel && i.carouselVisible > 1 && !i.carouselScaleHeight ? l : i.fullwidth && s / d > l ? l - c : s / d - c,
            ...
            if (n.data("newSW", u), n.data("newSH", h), i.carousel ? n.css({
                    ...
                    height: n.height() + "px"
                }), h = h > i.scaleMinHeight || "auto" === i.scaleMinHeight ? h : i.scaleMinHeight, n.data("newSH", h)), !n.data("setup") || i.carousel && i.carouselVisible > 1) return !1;
            var v = e.is("[data-image]") ? "image" : "video",
            ...
            e.find("img, iframe, video, .mejs-container").not(".tms-caption img, .tms-caption iframe, .tms-caption video").each(function() {
                var t, n, s;
                if ("image" === v ? (t = a(this).width(), n = a(this).height()) : "video" === v && ((!i.respectRatio && !w || i.fullscreen && !w) && e.addClass("tms-video-no-ratio"), w ? (t = i.fullwidth ? h * y : u, n = i.fullwidth ? h : u / y) : (t = a(this).attr("width") && u > a(this).attr("width") ? a(this).attr("width") : u, n = t / y)), s = t / n, "image" === v && i.fullscreen || g || "video" === v && w) {
                    if (a(this).is("img") && !a(this).data("loaded")) return !1;
                    a(this).css(f > s ? {
                        width: i.fullwidth && !g ? "auto" : u + "px",
                        height: Math.round(u / s) + "px",
                        top: Math.round(-((u / s - h) / 2)) + "px",
                        left: 0
                    } : {
                        width: !i.fullwidth || g || w ? Math.round(h * s) + "px" : "auto",
                        height: h + "px",
                        top: 0,
                        left: Math.round(-((h * s - u) / 2)) + "px"
                    })
                } else "video" === v && a(this).css({
                    width: Math.floor(t) + "px",
                    height: Math.floor(n) + "px",
                    top: Math.floor((h - n) / 2) + "px",
            ...
            return !t.captionScaling || t.carouselVisible > 1 ? !1 : (e.find(".tms-caption").each(function() {
                if (!a(this).is("[data-no-scale]")) {
                    var e = a(this),
                        ...
                        x = e.data("bl"),
                        S = e.data("fs"),
                        C = 0 === e.data("lh") ? S : e.data("lh"),
                        T = e.is("[data-offsetx]") ? parseFloat(e.data("offsetx")) : 0,
                        F = e.is("[data-offsety]") ? parseFloat(e.data("offsety")) : 0,
                        z = 0 > s * (T / r) ? s * (T / r) : s * (T / r) > T ? T : s * (T / r),
                        O = 0 > o * (F / l) ? s * (F / r) : s * (F / r) > F ? F : o * (F / l);
                    t.fullwidth && F > O && 0 > O && (O = F);
                    var $;
                    e.find("img, iframe, video").length && ($ = s * (d / r) > d ? d : s * (d / r) > s ? s : s * (d / r)), e.css(e.find("img").length || e.find("iframe, video").length ? {
                        width: $ + "px",
                        height: e.children("iframe, video").length ? $ / 1.778 + "px" : "auto"
                    } : {
                        fontSize: s * (S / r) > S ? S : s * (S / r) + "px",
                        lineHeight: s * (C / r) > C ? C + "px" : s * (C / r) + "px",
                        ...
                        top: "top" === n ? 0 + O : "bottom" === n ? o - e.outerHeight() - O : (o - e.outerHeight()) / 2 + O + "px",
                        left: "left" === i ? 0 + z : "right" === i ? s - e.outerWidth() - z : (s - e.outerWidth()) / 2 + z + "px"
                    })
                }
            }), i)
        },
        w = function(e, t) {
            return t.carouselVisible > 1 ? !1 : (e.find(".tms-caption").not(".no-transition").each(function() {
                var e = a(this),
                    ...
                    o = e.data("rx") ? parseFloat(e.data("rx")) : 0,
        ...
        y = function(e, t, n) {
            ...
            try {
                if (e.find("iframe").length) {
                    ...
                    var o = a(s).attr("src");
                    i !== o && o.indexOf("vimeo") > -1 ? (s = $f(a(s)[0]), s.api("play" === t && n.autoPlay ? "play" : "pause")) : i !== o && o.indexOf("youtu") > -1 && (s = s.replace("#", ""), "play" === t && n.autoPlay ? x[s].playVideo() : x[s].stopVideo())
    ...
    var z, O = e.body || e.documentElement,
        $ = O.style,
        A = $.transition !== i || $.WebkitTransition !== i || $.MozTransition !== i || $.MsTransition !== i || $.OTransition !== i,
        H = ["WebkitTransform", "MozTransform", "OTransform", "msTransform"];
    for (var k in H) $[H[k]] !== i && (z = "-" + H[k].replace("Transform", "").toLowerCase());
    var P = z + "-transform",
